...
export async function findMemberByLicenseHash(
  ...
  const url = `${env.SUPABASE_URL}/rest/v1/members?license_code_hash=eq.${licenseHash}&select=id,full_name,zone,good_standing,active,approval_status,is_elecom,contact_email&limit=1`;
